...
<body style="background:url(/seinfo/lib/img/main_bg.png) repeat-x;">
    ...
    <div class="col-sm-offset-3 col-sm-6" style="margin-top: 1%; background-color: #FFFFFF; height: 600px; border: #CCC solid 1px; box-shadow: 2px 2px 10px #c0c0c0;" >
        ...
        <ul class="unstyled">
            <?php if(is_array($li)): $i = 0; $__LIST__ = $li;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$li): $mod = ($i % 2 );++$i;?><li style="width:600px; margin-top: 10px;"><a href="__ROOT__/index.php/Person/get_file?fid=<?php echo ($li["fid"]); ?>"><?php echo ($li["filename"]); ?></a><span style="float: right;">&nbsp&nbsp&nbsp&nbsp<?php echo (date('Y-m-d H:i:s',$li["time"])); ?></span><a href="__URL__/dele_file?fid=<?php echo ($li["fid"]); ?>" style="float:right">x</a></li><?php endforeach; endif; else: echo "" ;endif; ?>   
        </ul>
    </div>
